 ...
 * @author h7moreir
 */
public class TransitionToPursue extends UT2004BotModuleController<UT2004Bot> implements Transition {

    @Override
    public HunterState transition(HunterBot Bot) {

        if(Bot.enemy != null && Bot.shouldPursue && Bot.getWeaponry().hasLoadedWeapon()){
